...
def save_q_p_info(q,p,params,ent_opt,case):
    ...
    os.system("mkdir _q_p_info_case"+str(model)+str(ent_opt)+str(case))

    out1 = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_q0_info.txt", "w"); out1.close()
    out2 = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_q1_info.txt", "w"); out2.close()
    out3 = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_p0_info.txt", "w"); out3.close()
    out4 = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_p1_info.txt", "w"); out4.close()

    for traj in xrange(ntraj):

        out1 = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_q0_info.txt", "a")
        out2 = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_q1_info.txt", "a")
        out3 = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_p0_info.txt", "a")
        out4 = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_p1_info.txt", "a")
...
def get_q_p_info(params, ent_opt, case):
    """
    ...
    aa = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_q0_info.txt","r")
    bb = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_q1_info.txt","r")
    cc = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_p0_info.txt","r")
    dd = open("_q_p_info_case"+str(model)+str(ent_opt)+str(case)+"/_p1_info.txt","r")
